...
if __name__ == '__main__':
    ...
    if not material in [line.body for line in bpy.data.texts["BML_material_list"].lines]: #### Peut �tre mieux de rajouter une option lors de l'import, plus pratique ensutie avec les tags, plus s�r
